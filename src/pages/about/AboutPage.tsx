                        ...
                        <div className="row align-items-center justify-content-between">
                            <div className="col-12">
                                <div className="breadcrumb__content text-center">
                                    <h2 className="breadcrumb__title mb-15 mb-sm-10 mb-xs-5 color-white title-animation">About Us</h2>
                                    ...
                                    <div className="about-us-2__main-content__list">
                                        <div className="about-us-2__main-content__list-item">
                                            ...
                                            <div className="about-us-2__main-content__list-item-text">
                                                <h4 className="mb-10 title-animation">MedNest Wellness</h4>
                                                <p className="mb-0">Nemo enim ipsam voluptatem quia voluptas sit aspernatur odit aut fugit</p>
                                            </div>
                                        </div>
                                        <div className="about-us-2__main-content__list-item">
                                            <div className="about-us-2__main-content__list-item-icon">
                                            ...
                                            <div className="about-us-2__main-content__list-item-text">
                                                <h4 className="mb-10 title-animation">Pulse Care Solutions</h4>
                                                <p className="mb-0">Nemo enim ipsam voluptatem quia voluptas sit aspernatur odit aut fugit</p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="row mb-minus-50">
                            <div className="col-xl-3 col-lg-4 col-sm-6">
                                <div className="service-3__item mb-50">
                                    ...
                                    <p className="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sit am rcus nunc. Duis egestas ac ante sed tincidunt</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-lg-4 col-sm-6">
                                <div className="service-3__item mb-50">
                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-6">
                                <div className="wellness-expertise__content">
                                    <h2 className="section__title mb-15 mb-xs-10  title-animation">Revitalize Radiance Your Wellness Expertise</h2>
                                    <p className="mb-40 mb-xs-30">Lorem ipsum dolor sit amet, consectetur adipiLorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sit amet rcus nunc. Duis egestas ac ante sed tincidunt. Lorem ipsum dolor sit ametscing elit. Sed sit amet</p>
                        ...
                        <div className="row align-items-end mb-60 mb-sm-50 mb-xs-40">
                            ...
                            <div className="col-lg-5">
                                <div className="client-testimonial__content-right mt-md-25 mt-sm-25 mt-xs-25">
                                    <p className="mb-0">Medical science encompasses a vastf fields dedicated to understanding and treating ailments, promotin health, and enhanci quality of life. Here's a brief exploration into this multifaceted domain medical student</p>
                                </div>
                            </div>
                        </div>
